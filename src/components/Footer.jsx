    ...
    <footer className=" rounded-lg shadow bg-gray-900 m-4">
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex items-center sm:justify-between">
          ...
          <ul className="grid grid-cols-2 sm:flex flex-wrap items-center mb-6 text-sm font-medium text-gray-400 sm:mb-0 dark:text-gray-300">
            <li>
        ...
        <span className="block text-sm text-gray-300 sm:text-center dark:text-gray-400 mb-1">
          A project by{" "}
