    ...
    <div>
      <div className="group relative shadow-inner rounded-lg">
        ...
        <div className="mt-4 flex justify-between group-hover:opacity-75">
          {/* genre */}
          <div>
            <p className="text-sm text-left ml-2 font-medium text-gray-900">{data.genre_names.toString()}</p>
          </div>
          {/* rating */}
          <div className="flex">
            <svg
            ...
            <p className=" mx-2 text-sm font-medium text-gray-900">{Math.round(data.vote_average * 10) / 10}</p>
          </div>
        </div>
        ...
        <div className="px-2">
          ...
          {/* overview */}
          <p className="flex mt-1 text-sm text-gray-500 line-clamp-3 h-14">{data.overview}</p>
        </div>
          ...
          <div className="flex flex-col gap-3 items-start bg-white/90  rounded-xl px-4 py-3 shadow-md w-full">
            <div className="flex items-start w-full mb-3">
              ...
              <div className="w-12 h-12 rounded-lg  overflow-hidden mr-2">
                <img src={data.poster_url} alt={data.title} className="relative bg-no-repeat bg-cover z-10" />
              </div>
              {/* card details */}
              <div className="flex flex-col">
                ...
                {/* year */}
                <p className="text-sm text-gray-600 font-bold">{data.release_date}</p>
              </div>
            </div>
            {/* overview */}
            <p className="h-3/4 text-xs">{data.overview}</p>
          </div>
        </div>
      </div>
    </div>
