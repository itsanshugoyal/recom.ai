...
function PodcastItem(cover_image, title, genre, rating, external_link, overview) {
  return (
    <div>
      {
    ...
    //   {/* Cover    image */}
    //   <a href="#">
    //     <img className=" p-4 rounded-t-lg" src="https://media.timeout.com/images/105870081/750/562/image.jpg" alt="" />
    //     {/* <img
    ...
    //     {/* Title */}
    //     <a href="#">
    //       <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-black">Heavyweight</h5>
    //     </a>
    //     {/* Book description */}
    //     <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
    //       'Heavyweight' caused a storm for a reason. It's a podcast that many of us have been searching for for years,
    //       even if we didn't know it yet. Ever lay awake at night, wincing about that thing you did five years ago?
    //       Podcast host Jonathon Goldstein wants to hear it. The podcast works through listeners' most painful memories,
    //       dissecting and working through them
    //     </p>
