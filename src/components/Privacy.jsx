    ...
    <main classNameName="h-full bg-[#EEF0F2] ">
      <div className="items-start m-auto md:w-2/4 justify-start flex px-12">
        <div className="container my-8 text-left text-lg">
          ...
          <p className="my-2 text-gray-600">Last updated: December 20, 2023</p>
          ...
          <h2 className="font-bold text-2xl my-6">Interpretation and Definitions</h2>
          <h3 className="font-semibold text-xl my-2">Interpretation</h3>
          <p className="my-2 text-gray-600">
            The words of which the initial letter is capitalized have meanings defined under the following conditions.
            The following definitions shall have the same meaning regardless of whether they appear in singular or in
            plural.
          </p>
          <h3 className="font-semibold text-xl my-2">Definitions</h3>
          <p className="my-2 text-gray-600">For the purposes of this Privacy Policy:</p>
          ...
          <h2 className="font-bold text-2xl my-6">Collecting and Using Your Personal Data</h2>
          <h3 className="font-semibold text-xl my-2">Types of Data Collected</h3>
          <h4 className="font-medium my-2 text-lg">Personal Data</h4>
          <p className="my-2 text-gray-600">
          ...
          <ul className="list-disc px-14">
            <li>
              <p className="my-2 text-gray-600">Email address</p>
            </li>
            <li>
              <p className="my-2 text-gray-600">First name and last name</p>
            </li>
            <li>
              <p className="my-2 text-gray-600">Usage Data</p>
            </li>
          </ul>
          <h4 className="font-semibold text-lg">Usage Data</h4>
          <p className="my-2 text-gray-600">Usage Data is collected automatically when using the Service.</p>
          <p className="my-2 text-gray-600">
          ...
          <h4 className="font-semibold text-lg">Tracking Technologies and Cookies</h4>
          <p className="my-2 text-gray-600">
          ...
          <ul className="list-disc px-14">
            <li>
              ...
              <p className="my-2 text-gray-600">Type: Session Cookies</p>
              <p className="my-2 text-gray-600">Administered by: Us</p>
              <p className="my-2 text-gray-600">
            ...
            <li>
              ...
              <p className="my-2 text-gray-600">Type: Persistent Cookies</p>
              <p className="my-2 text-gray-600">Administered by: Us</p>
              <p className="my-2 text-gray-600">
          ...
          <h3 className="font-semibold text-xl my-2">Use of Your Personal Data</h3>
          <p className="my-2 text-gray-600">The Company may use Personal Data for the following purposes:</p>
          <ul className="list-disc px-14">
            <li>
              <p className="my-2 text-gray-600">
          ...
          <p className="my-2 text-gray-600">We may share Your personal information in the following situations:</p>
          <ul className="list-disc px-14">
            <li className="my-2 text-gray-600">
          ...
          <h3 className="font-semibold text-xl my-2">Retention of Your Personal Data</h3>
          <p className="my-2 text-gray-600">
          ...
          <h3 className="font-semibold text-xl my-2">Transfer of Your Personal Data</h3>
          <p className="my-2 text-gray-600">
          ...
          <h3 className="font-semibold text-xl my-2">Delete Your Personal Data</h3>
          <p className="my-2 text-gray-600">
          ...
          <h3 className="font-semibold text-xl my-2">Disclosure of Your Personal Data</h3>
          <h4 className="font-semibold text-lg">Business Transactions</h4>
          <p className="my-2 text-gray-600">
          ...
          <h4 className="font-semibold text-lg">Law enforcement</h4>
          <p className="my-2 text-gray-600">
          ...
          <h4 className="font-semibold text-lg">Other legal requirements</h4>
          <p className="my-2 text-gray-600">
            The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:
          </p>
          <ul className="list-disc px-14">
            <li className="my-2 text-gray-600">Comply with a legal obligation</li>
            <li className="my-2 text-gray-600">Protect and defend the rights or property of the Company</li>
            <li className="my-2 text-gray-600">
              Prevent or investigate possible wrongdoing in connection with the Service
            </li>
            <li className="my-2 text-gray-600">Protect the personal safety of Users of the Service or the public</li>
            <li className="my-2 text-gray-600">Protect against legal liability</li>
          </ul>
          <h3 className="font-semibold text-xl my-2">Security of Your Personal Data</h3>
          <p className="my-2 text-gray-600">
          ...
          <h2 className="font-bold text-2xl my-6">Children's Privacy</h2>
          <p className="my-2 text-gray-600">
          ...
          <h2 className="font-bold text-2xl my-6">Links to Other Websites</h2>
          <p className="my-2 text-gray-600">
          ...
          <h2 className="font-bold text-2xl my-6">Contact Us</h2>
          <p className="my-2 text-gray-600">If you have any questions about this Privacy Policy, You can contact us:</p>
          <ul className="list-disc px-14">
            <li className="my-2 text-gray-600">By email: itsanshugoyal@gmail.com</li>
          </ul>
        </div>
      </div>
    </main>
