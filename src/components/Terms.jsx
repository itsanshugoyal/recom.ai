    ...
    <main classNameName="h-full bg-[#EEF0F2] ">
      <div className="items-start m-auto md:w-2/4 justify-start flex px-12">
        <div className="container my-8 text-left text-lg">
          ...
          <p className="my-2 text-gray-600 text-xl italic font-medium">
            Welcome to <a href="https://recommendmesomething.com/">Recommend Me Something</a> !
          </p>

          <p className="my-2 text-gray-600">
            These terms and conditions outline the rules and regulations for the use of Recommend Me Something's
            Website, located at https://recommendmesomething.com/.
          </p>

          <p className="my-2 text-gray-600">
            By accessing this website we assume you accept these terms and conditions. Do not continue to use Recommend
            Me Something if you do not agree to take all of the terms and conditions stated on this page.
          </p>
          ...
          <p className="my-2 text-gray-600">
            ...
            the Company's terms and conditions. "The Company", "Recommend Me Something", "Ourselves", "We", "Our" and
            "Us", refers to our Company. "Party", "Parties", or "Us", refers to both the Client and ourselves. All terms
          ...
          <p className="my-2 text-gray-600">
            We employ the use of cookies. By accessing Recommend Me Something, you agreed to use cookies in agreement
            with the Recom Ai's Privacy Policy.
          </p>
          ...
          <p className="my-2 text-gray-600">
            Unless otherwise stated, Recommend Me Something and/or its licensors own the intellectual property rights
            for all material on Recommend Me Something. All intellectual property rights are reserved. You may access
            this from Recommend Me Something for your own personal use subjected to restrictions set in these terms and
            conditions.
          </p>

          <p className="my-2 text-gray-600">You must not:</p>
          <ul className="list-disc px-14">
            <li className="my-2 text-gray-600">Republish material from Recommend Me Something</li>
            <li className="my-2 text-gray-600">Sell, rent or sub-license material from Recommend Me Something</li>
            <li className="my-2 text-gray-600">Reproduce, duplicate or copy material from Recommend Me Something</li>
            <li className="my-2 text-gray-600">Redistribute content from Recommend Me Something</li>
          </ul>
          ...
          <p className="my-2 text-gray-600">
            ...
            certain areas of the website. Recommend Me Something does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views and opinions of Recommend Me
            Something,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their
            views and opinions. To the extent permitted by applicable laws, Recommend Me Something shall not be liable
          ...
          <p className="my-2 text-gray-600">
            Recommend Me Something reserves the right to monitor all Comments and to remove any Comments which can be
            considered inappropriate, offensive or causes breach of these Terms and Conditions.
          </p>

          <p className="my-2 text-gray-600">You warrant and represent that:</p>
          ...
          <p className="my-2 text-gray-600">
            You hereby grant Recommend Me Something a non-exclusive license to use, reproduce, edit and authorize others
          ...
          <ul className="list-disc px-14">
            <li className="my-2 text-gray-600">Government agencies;</li>
            <li className="my-2 text-gray-600">Search engines;</li>
            <li className="my-2 text-gray-600">News organizations;</li>
            <li className="my-2 text-gray-600">
          ...
          <ul className="list-disc px-14">
            <li className="my-2 text-gray-600">commonly-known consumer and/or business information sources;</li>
            <li className="my-2 text-gray-600">dot.com community sites;</li>
            <li className="my-2 text-gray-600">associations or other groups representing charities;</li>
            <li className="my-2 text-gray-600">online directory distributors;</li>
            <li className="my-2 text-gray-600">internet portals;</li>
            <li className="my-2 text-gray-600">accounting, law and consulting firms; and</li>
            <li className="my-2 text-gray-600">educational institutions and trade associations.</li>
          </ul>
          ...
          <p className="my-2 text-gray-600">
            ...
            of Recommend Me Something; and (d) the link is in the context of general resource information.
          </p>
          ...
          <p className="my-2 text-gray-600">
            ...
            website, you must inform us by sending an e-mail to Recommend Me Something. Please include your name, your
          ...
          <p className="my-2 text-gray-600">Approved organizations may hyperlink to our Website as follows:</p>

          <ul className="list-disc px-14">
            <li className="my-2 text-gray-600">By use of our corporate name; or</li>
            <li className="my-2 text-gray-600">By use of the uniform resource locator being linked to; or</li>
            <li className="my-2 text-gray-600">
          ...
          <p className="my-2 text-gray-600">
            No use of Recommend Me Something's logo or other artwork will be allowed for linking absent a trademark
            license agreement.
          </p>
          ...
          <ul className="list-disc px-14">
            <li className="my-2 text-gray-600">limit or exclude our or your liability for death or personal injury;</li>
            <li className="my-2 text-gray-600">
