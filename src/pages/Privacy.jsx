...
function Privacy() {
  return (
    <main className="w-full bg-[#EEF0F2] pt-12 py-10">
      <Helmet>
        <title>Privacy Policy - recommendmesomething</title>
        <meta
          name="description"
        ...
        />
        <meta name="keywords" content="privacy, policy, privacy policy, recommend me something, recommendmesomething" />
        {/* <meta name="author" content={postDetail.author.name} /> */}
        <meta property="og:title" content="Privacy Policy - recommendmesomething" />
        <meta
        ...
        <meta name="twitter:title" content="Privacy Policy - recommendmesomething" />
        <meta
      ...
      <div className="items-start m-auto w-11/12 sm:w-5/6 lg:w-7/12  justify-start flex  bg-white rounded-lg md:p-12 p-6  sm:p-16">
        <div className="container my-8 text-left text-lg text-gray-600 flex flex-col gap-4">
          <h1 className="my-8 font-extrabold text-4xl text-center text-sky-900">Privacy Policy</h1>
          ...
          <h2 className="font-bold text-2xl  text-gray-95 text-gray-900">Interpretation and Definitions</h2>
          <h3 className="text-gray-900 font-semibold text-xl my-2">Interpretation</h3>
          <p>
            The words of which the initial letter is capitalized have meanings defined under the following conditions.
            The following definitions shall have the same meaning regardless of whether they appear in singular or in
            plural.
          </p>
          <h3 className="text-gray-900 font-semibold text-xl my-2">Definitions</h3>
          <p>For the purposes of this Privacy Policy:</p>
          <ul className="list-disc md:px-14 px-4">
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                <a href="https://recommendmesomething.com" rel="external nofollow noopener noreferrer" target="_blank">
          ...
          <h2 className="font-bold text-2xl my-6 text-gray-900">Collecting and Using Your Personal Data</h2>
          <h3 className="text-gray-900 font-semibold text-xl my-2">Types of Data Collected</h3>
          <h4 className="text-gray-800 font-medium my-2 text-lg">Personal Data</h4>
          <p>
          ...
          <h4 className="text-gray-800 font-semibold text-lg">Usage Data</h4>
          ...
          <h4 className="text-gray-800 font-semibold text-lg">Tracking Technologies and Cookies</h4>
          <p>
          ...
          <p>
            ...
            <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies" target="_blank" rel="noreferrer">
              TermsFeed website
            </a>{" "}
            article.
          </p>
          ...
          <h3 className="text-gray-900 font-semibold text-xl my-2">Use of Your Personal Data</h3>
          ...
          <h3 className="text-gray-900 font-semibold text-xl my-2">Retention of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-gray-900 font-semibold text-xl my-2">Transfer of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-gray-900 font-semibold text-xl my-2">Delete Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-gray-900 font-semibold text-xl my-2">Disclosure of Your Personal Data</h3>
          <h4 className="text-gray-800 font-semibold text-lg">Business Transactions</h4>
          <p>
          ...
          <h4 className="text-gray-800 font-semibold text-lg">Law enforcement</h4>
          <p>
          ...
          <h4 className="text-gray-800 font-semibold text-lg">Other legal requirements</h4>
          ...
          <h3 className="text-gray-900 font-semibold text-xl my-2">Security of Your Personal Data</h3>
          <p>
          ...
          <h2 className="font-bold text-2xl my-6 text-gray-900">Children's Privacy</h2>
          <p>
          ...
          <h2 className="font-bold text-2xl my-6 text-gray-900">Links to Other Websites</h2>
          <p>
          ...
          <h2 className="font-bold text-2xl my-6 text-gray-900">Changes to this Privacy Policy</h2>
          <p>
          ...
          <h2 className="font-bold text-2xl my-6 text-gray-900">Contact Us</h2>
          <p>If you have any questions about this Privacy Policy, You can contact us:</p>
          <ul className="list-disc md:px-14 px-4">
            <li>By email: itsanshugoyal@gmail.com</li>
          </ul>
        </div>
      </div>
    </main>
